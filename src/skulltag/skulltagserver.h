...
class SkulltagServer : public Server
{
	...
	public:
		enum SkulltagQueryFlags
		{
			...
			SQF_STANDARDQUERY =		SQF_NAME|SQF_URL|SQF_MAPNAME|SQF_MAXCLIENTS|SQF_MAXPLAYERS|SQF_PWADS|SQF_GAMETYPE|SQF_IWAD|SQF_FORCEPASSWORD|SQF_FORCEJOINPASSWORD|SQF_DMFLAGS|SQF_LIMITS|SQF_NUMPLAYERS|SQF_PLAYERDATA|SQF_TEAMINFO_NUMBER|SQF_TEAMINFO_SCORE
		};
