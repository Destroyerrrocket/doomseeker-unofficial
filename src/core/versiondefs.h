...
#define VERSION_STRING "0.12 Beta"

// Info used by windows.rc
#define FILEVERSION_DEF 0,12,0,SVN_REVISION_NUMBER
#define PRODUCTVERSION_DEF 0,12,0,SVN_REVISION_NUMBER
#define FILEVERSION_STR_DEF "0.12.0.0"
#define PRODUCTVERSION_STR_DEF "0.12.0.0"
