...
#define FILEVERSION_DEF 0,10,0,SVN_REVISION_NUMBER
#define PRODUCTVERSION_DEF 0,10,0,SVN_REVISION_NUMBER
#define FILEVERSION_STR_DEF "0.10.0.0"
#define PRODUCTVERSION_STR_DEF "0.10.0.0"
