...
const QString TAUNT = "Taunt";
const QString USE_CROSSHAIRS = "UseCrosshairs";
const QString USE_LAND_CONSOLE_COMMAND = "UseLandConsoleCommand";
...
const QString USE_FOV = "UseFOV";
const QString USE_FREELOOK = "UseFreelook";
...
const QString SUICIDE = "Suicide";
const QString RESPAWN = "Respawn";
const QString USE_AUTOMAP = "UseAutomap";
const QString USE_AUTOAIM = "UseAutoaim";
...
const QString TARGET_IDENTIFY = "TargetIdentify";
const QString DISPLAY_COOP_INFO = "DisplayCoopInfo";
const QString MAX_BLOOD_SCALAR = "MaxBloodScalar";
const QString NO_ITEM_DROP = "NoItemDrop";
const QString ROCKET_JUMP = "RocketJump";
const QString USE_CUSTOM_GLLIGHTING_SETTINGS = "UseCustomGLLightingSettings";
const QString TURN_OFF_TRANSLUCENCY = "TurnOffTranslucency";
