...
: GameClientRunner(server)
{
	...
	set_addConnectCommand(&Srb2GameClientRunner::addConnectCommand);
	set_addExtra(&Srb2GameClientRunner::addExtra);
	set_addPassword(&Srb2GameClientRunner::addPassword);
}

void Srb2GameClientRunner::addConnectCommand()
{
...
void Srb2GameClientRunner::addPassword()
{
}
