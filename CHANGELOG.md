...
- Allow to pick *no* game mode when creating a game. The idea here is
to allow the game to decide on the game mode or to start into the title
screen. (addresses 3505)
